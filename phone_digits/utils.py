...
def upload_audio(file):
    """
    Used to upload prerecorded audio
    """
...
def mk_thresh_df(wfs_and_tags, thresh):
    ...
    """
    return pd.DataFrame(
        intensity_gen(wfs_and_tags=wfs_and_tags, thresh=thresh),
...
def barplot_thresh(fvs, thresh, title=""):
    """
...
def barplot_colored(fvs, results, title=""):
    """
...
def mk_event_location_plot(tags, title=""):
    """
